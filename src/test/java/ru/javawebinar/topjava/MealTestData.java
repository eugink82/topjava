...
public class MealTestData {
    ...
    public static List<Meal> MEALS = List.of(MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1);

    public static Meal createdMeal() {
        return new Meal(null, LocalDateTime.of(2015, Month.JUNE, 1, 17, 0), "Вечерний ланч", 750);
    }

    public static Meal updatedMeal() {
        return new Meal(MEAL_ID, LocalDateTime.of(2015, Month.MAY, 30, 10, 0), "Сиеста", 550);
    }
    ...
    public static ResultMatcher contentJson(MealTo... mealTo) {
        return contentJson(List.of(mealTo));
    }
