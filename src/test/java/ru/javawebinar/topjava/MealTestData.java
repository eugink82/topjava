...
public class MealTestData {
    ...
    public static final Meal MEAL_7 = new Meal(MEAL_ID + 6, LocalDateTime.of(2015, Month.JUNE, 4, 18, 0), "Ужин", 890);


    public static final Meal CREATED = new Meal(MEAL_ID + 10, LocalDateTime.of(2018, Month.JULY, 5, 13, 0), "Хавка", 530);
